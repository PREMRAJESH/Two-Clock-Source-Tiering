...
| `pt_pilot_results_merged.csv` | **Perception multi-run verification P(t)** — 250 records across 50 entities × 5 model cutoffs reporting 3-run repeat scores (`score_run1`, `score_run2`, `score_run3`, mean, std, agreement). | Empirically validates perception onset stability across repeated evaluations (v2 dataset, Zenodo DOI 10.5281/zenodo.22970684). | Received (v2 verification) |
