...
| **COMPLETE (manual)** | 27 AMBER precision-audit rows: extracted to `amber_rows_review.csv`, master values 21y/5 404/1 redirect (committed `3b50d5b`; export-bug fixed). |
...
- **Two manual labeling tasks completed:** the 27 AMBER precision rows
  (master values: 21y/5 404/1 redirect) and the 263-row contrast-week batch (78y/185n).
